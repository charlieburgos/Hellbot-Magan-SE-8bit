...
#define STRING_CONFIG_H_AUTHOR "(Charlieburgos)" // Who made the changes.
...
#define MOTHERBOARD BOARD_HELLBOT1284P01
...
#define CUSTOM_MACHINE_NAME "HELLBOT MAGNA SE 8BIT"
